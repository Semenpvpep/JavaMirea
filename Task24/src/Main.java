public class Main {
    public static void main(String[] args) {
        ...
        order1.add(dish1);
        order1.add(drink1);
        order1.setCustomer(new Customer("Семён", "Цаплёв", 10, new Address()));
        ...
        order2.add(dish2);
        order2.add(drink2);
        order2.setCustomer(new Customer("Вадик", "Найков", 38, new Address()));
        ...
        order3.add(dish3);
        order3.add(drink3);
        order3.setCustomer(new Customer("Боря", "Гречеедов", 18, new Address()));
        ...
        System.out.println("Оставшийся заказ:");
        ordersManager.show();
